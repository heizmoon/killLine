(function (global, factory) {
  ...
  function AddActive (items, pane, options = { title: 'Active' }) {
    const folder = pane.addFolder(options);
  ...
  function AddAlpha (items, pane, options = { title: 'Alpha' }) {
    const folder = pane.addFolder(options);
  ...
  function AddVisible (items, pane, options = { title: 'Visible' }) {
    const folder = pane.addFolder(options);
  ...
  function AddScenes (scenes, pane, options = { title: 'Scenes Visible' }) {
    const folder = pane.addFolder(options);
